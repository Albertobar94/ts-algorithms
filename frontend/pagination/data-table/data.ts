/**
 * User fixture for the Data Table note. 36 rows — enough to span several pages at
 * every page size (5 / 10 / 20), so the boundary cases (a partial last page, the
 * jump to page 4) actually show up when you click through.
 */
